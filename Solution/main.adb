...
T:Fmain$event[({0}S:S$hasEventBeenPlayed$0_0$0({1}SC:S),Z,0,0)({1}S:S$eventName$0_0$0({2}DG,SC:S),Z,0,0)({3}S:S$eventDuration$0_0$0({2}SI:U),Z,0,0)]
...
T:Fmain$sprite[({0}S:S$spriteInUse$0_0$0({1}SC:S),Z,0,0)({1}S:S$spriteCollisionBoundaries$0_0$0({2}DA2d,SC:U),Z,0,0)({3}S:S$spriteNumber$0_0$0({1}SC:U),Z,0,0)({4}S:S$spritePosition$0_0$0({2}DA2d,SC:U),Z,0,0)({6}S:S$spriteNumberTopLeft$0_0$0({2}SI:U),Z,0,0)({8}S:S$spriteNumberTopLeftX$0_0$0({2}SI:U),Z,0,0)({10}S:S$spriteNumberTopLeftY$0_0$0({2}SI:U),Z,0,0)]
...
S:G$currentNumberOfEvents$0_0$0({1}SC:U),E,0,0
S:G$sprites$0_0$0({480}DA40d,STsprite:S),E,0,0
S:G$spritesInUse$0_0$0({1}SC:U),E,0,0
S:G$trackMap$0_0$0({380}DA380d,SC:U),E,0,0
S:G$trackSprites$0_0$0({240}DA240d,SC:U),E,0,0
...
S:G$eventInitializer$0_0$0({2}DF,SC:S),C,0,0
S:G$tumblingBarrels$0_0$0({2}DF,SV:S),C,0,0
S:G$addSTU$0_0$0({2}DF,SC:S),C,0,0
S:G$sNTLUpdate$0_0$0({2}DF,SI:U),C,0,0
S:G$defaultSpriteStruct$0_0$0({2}DF,SV:S),C,0,0
